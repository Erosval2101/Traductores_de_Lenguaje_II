...
namespace analizadorLexico
{
    ...
    class AnalizadorLexico
    {
        ...
        public void cargarMatriz()
        {
            ...
            String[] lineas = File.ReadAllLines(@"D:\Practicas\Cosas de C#\Actividades STL II\Analizador Sintactico\Tarea 5\analizadorLexico\compilador.lr", Encoding.Default);
        ...
        public void cargarReglas()
        {
            int delimitador = 9;
            char _dem = Convert.ToChar(delimitador);
            string[] lineas = File.ReadAllLines(@"D:\Practicas\Cosas de C#\Actividades STL II\Analizador Sintactico\Tarea 5\analizadorLexico\reglas.txt", Encoding.Default);
